...
type AuroraShaderBgProps = {
  /** If you want to overlay content on top of shader */
  children?: React.ReactNode;
  /** fixed height, e.g. "h-screen" or "h-[650px]" */
  className?: string;
};
...
export default function AuroraShaderBg({
  ...
  useEffect(() => {
        ...
        void main() {
          ...
          for (float i = 0.0; i < 35.0; i++) {
            ...
            vec4 currentContribution =
              auroraColors * exp(sin(i * i + iTime * 0.8))
    ...
    // Resize via ResizeObserver (best)
